...
export class SchemaParser {
    parse() {
        mapSchema(_classPrivateFieldGet(this, _schema), {
            ...
            [MapperKind.OBJECT_TYPE]: (type)=>{
                _classPrivateFieldGet(this, _def).objects[type.name] = this._parseObject(type);
                const model = this._parseModelDirective(type);
                if (model != null) {
    ...
    _parseViews(objectName, fieldName, type, directives) {
