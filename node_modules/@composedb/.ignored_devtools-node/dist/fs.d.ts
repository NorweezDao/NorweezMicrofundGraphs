 ...
 */
export declare function createComposite(ceramic: CeramicClient | string, path: PathInput): Promise<Composite>;
/**
 * Create a Composite from a JSON-encoded definition path.
 */
export declare function readEncodedComposite(ceramic: CeramicClient | string, path: PathInput): Promise<Composite>;
/**
