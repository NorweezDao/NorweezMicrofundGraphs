...
/** @internal */ export async function fromAbstractModel(ceramic, model) {
    return model.action === 'create' ? await Model.create(ceramic, model.definition) : await Model.load(ceramic, model.id);
}
